        ...
        <div className="flex flex-row gap-4">
          <div className="mb-4 w-full">
            <div className="flex mb-4 ml-auto">
              <button
                onClick={() => navigate(-1)}
                className="inline-flex text-white bg-indigo-500 border-0 py-1.5 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg ml-auto"
              >
                Go back
              </button>
            </div>
              ...
              <div>
                ...
                <div className="flex flex-row gap-4 mb-2">
                  ...
                  <div className="relative w-full">
                    ...
                    >
                      <option defaultValue={user.civil_status}>{user.civil_status}</option>
                      {user.civil_status != "Single" && <option value={"Single"}>Single</option>}
                      {user.civil_status != "Married" && <option value={"Married"}>Married</option>}
                    </select>
                  </div>
                </div>
                <div className="flex flex-row gap-4 mb-2">
                ...
                <div className="flex flex-row gap-4 mb-2">
                  ...
                  <div className="relative w-full">
                    <label htmlFor="graduate" className="leading-7 text-sm text-gray-600">
                      Graduate
                    </label>
                    ...
                    <select
                      ...
                      onChange={(e) => {}}
                    >
                      <option defaultValue={"graduate"}>Graduate</option>
                ...
                <div className="flex flex-row gap-4 mb-2">
                  ...
                  <div className="relative w-full">
                    <label htmlFor="finish" className="leading-7 text-sm text-gray-600">
                      Year End
                    </label>
                    <input
                      type="text"
