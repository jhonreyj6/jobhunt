const Message = () => {
    return (
        <>
            <div className="flex flex-row h-screen antialiased text-gray-800 pt-16">
                <div className="flex flex-row w-96 flex-shrink-0 bg-gray-100">
                                    ...
                                    <div className="flex flex-row items-center">
                                        ...
                                        <div className="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl">
                                            <div>
                                                Lorem ipsum dolor sit amet,
                                                consectetur adipisicing elit.
                                                Vel ipsa commodi illum saepe
                                                numquam maxime asperiores
                                                voluptate sit, minima
                                                perspiciatis.
                                            </div>
                                        </div>
                                    </div>
