            ...
            <div className="bg-indigo-50 mb-8">
                <div className="px-4 py-8 max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-3 mb-8">
                        ...
                        <div className="col-span-1 border border-indigo-700 p-4 text-center">
                            <div className="bg-indigo-700 w-16 mx-auto mb-2 px-2 py-3 rounded-full">
                                <i className="bi bi-person-workspace text-3xl text-white"></i>
                            </div>
                            <div className="mb-1 text-xl font-semibold">
                                Virtual Assistant
                            </div>
                        ...
                        <div className="col-span-1 border border-indigo-700 p-4 text-center">
                            <div className="bg-indigo-700 w-16 mx-auto mb-2 px-2 py-3 rounded-full">
                                <i className="bi bi-google-play text-3xl text-white"></i>
                            </div>
                            <div className="mb-1 text-xl font-semibold">
                                Web & App Development
                            </div>
                        ...
                        <div className="col-span-1 border border-indigo-700 p-4 text-center">
                            <div className="bg-indigo-700 w-16 mx-auto mb-2 px-2 py-3 rounded-full">
                                <i className="bi bi-person-standing-dress text-3xl text-white"></i>
                            </div>
                            <div className="mb-1 text-xl font-semibold">
                                Designer
                            </div>
                        ...
                        <div className="col-span-1 border border-indigo-700 p-4 text-center">
                            <div className="bg-indigo-700 w-16 mx-auto mb-2 px-2 py-3 rounded-full">
                                <i className="bi bi-play-btn-fill  text-3xl text-white"></i>
                            </div>
                            <div className="mb-1 text-xl font-semibold">
                                Video Editor
                            </div>
